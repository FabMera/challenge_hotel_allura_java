...
public class ReservasView extends JFrame {
    ...
    public static void calcularValor() {
        ...
        txtValor.setText(String.valueOf(dias * 100000));

    }


    //metodo para guardar los datos de la reserva
    public void guardar() {
        var reserva = new HashMap<String, String>();
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");

        String fecha_entrada = sdf.format(txtFechaEntrada.getDate());
        String fecha_salida = sdf.format(txtFechaSalida.getDate());
        String valor = txtValor.getText();
        String forma_pago = Objects.requireNonNull(txtFormaPago.getSelectedItem()).toString();

        reserva.put("fecha_entrada", fecha_entrada);
        reserva.put("fecha_salida", fecha_salida);
        reserva.put("valor", valor);
        reserva.put("forma_pago", forma_pago);

        try {
            this.reservasController.guardarReserva(reserva);
